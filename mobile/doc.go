...
// Package geth contains the simplified mobile APIs to Elastos.ELA.SideChain.EID.
//
// The scope of this package is *not* to allow writing a custom Ethereum client
// with pieces plucked from Elastos.ELA.SideChain.EID, rather to allow writing native dapps on
...
// from the Elastos.ELA.SideChain.EID repository. Please adhere to this scoping to prevent this
// package getting unmaintainable.
//
// Wrapping guidelines:
//
// Every type that is to be exposed should be wrapped into its own plain struct,
// which internally contains a single field: the original Elastos.ELA.SideChain.EID version.
