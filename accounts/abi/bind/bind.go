...
//
// Detailed usage document and tutorial available on the Elastos.ELA.SideChain.EID Wiki page:
// https://github.com/elastos/Elastos.ELA.SideChain.EID/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
