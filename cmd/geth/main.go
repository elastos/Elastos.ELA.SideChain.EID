...
var (
	...
	app = utils.NewApp(gitCommit, gitDate, "the Elastos.ELA.SideChain.EID command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2013-2019 The Elastos.ELA.SideChain.EID Authors"
