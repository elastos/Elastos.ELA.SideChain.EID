...
const (
	ipcAPIs  = "admin:1.0 bridge:1.0 debug:1.0 did:1.0 eth:1.0 miner:1.0 net:1.0 pbft:1.0 personal:1.0 rpc:1.0 shh:1.0 txpool:1.0 web3:1.0"
...
func TestConsoleWelcome(t *testing.T) {
	...
	geth.SetTemplateFunc("niltime", func() string { return time.Unix(1623945600, 0).Format(time.RFC1123) })
...
func testAttachWelcome(t *testing.T, geth *testgeth, endpoint, apis string) {
	...
	attach.SetTemplateFunc("niltime", func() string { return time.Unix(1623945600, 0).Format(time.RFC1123) })
