...
func TestFastVsFullChains(t *testing.T) {
	...
	ancientDb, err := rawdb.NewDatabaseWithFreezer(rawdb.NewMemoryDatabase(), frdir, "", gspec.Config)
	if err != nil {
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	makeDb := func() (ethdb.Database, func()) {
		...
		defer os.Remove(dir)
		db, err := rawdb.NewDatabaseWithFreezer(rawdb.NewMemoryDatabase(), dir, "", gspec.Config)
		if err != nil {
			t.Fatalf("failed to create temp freezer db: %v", err)
		}
		gspec.MustCommit(db)
...
//
// https://github.com/elastos/Elastos.ELA.SideChain.EID/pull/15941
...
//
// Details at:
//  - https://github.com/elastos/Elastos.ELA.SideChain.EID/issues/18977
//  - https://github.com/elastos/Elastos.ELA.SideChain.EID/pull/18988
...
func testInsertKnownChainData(t *testing.T, typ string) {
	...
	defer os.Remove(dir)
	chaindb, err := rawdb.NewDatabaseWithFreezer(rawdb.NewMemoryDatabase(), dir, "", params.TestChainConfig)
	if err != nil {
		t.Fatalf("failed to create temp freezer db: %v", err)
	}
